...
To connect these buttons you must declare behaviour `scrollbar` in field `\renschs\yii2\swiper\Swiper::$behaviours`, 
...
You can configure scrollbar through the field `\renschs\yii2\swiper\Swiper::$scrollbarOptions`. 
